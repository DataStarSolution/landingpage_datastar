...
const SERVICES = [
  { icon: "💬", title: "Automação com WhatsApp", color: "#25D366", category: "automacao", tags: ["Chatbots", "ERP"], desc: "Bots de atendimento e agendamento integrados." },
  { icon: "🧠", title: "IA com Documentos (RAG)", color: "#AA6BFF", category: "ia", tags: ["RAG", "LLM"], desc: "IAs que aprendem com manuais e PDFs." },
  { icon: "📊", title: "Análise de Dados & BI", color: "#00D4AA", category: "dados", tags: ["Power BI", "SQL"], desc: "Dashboards e insights estratégicos." },
  // ... outros serviços
];
...
export default function Services() {
  ...
  return (
    <section id="servicos" style={{ padding: "100px 5%" }}>
      <div style={{ color: "#00D4AA", fontSize: 11, fontWeight: 700, textTransform: "uppercase", marginBottom: 12 }}>O que fazemos</div>
